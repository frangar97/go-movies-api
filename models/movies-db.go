...
func (m *DBModel) UpdateMovie(movie Movie) error {
	...
	_, err := m.DB.ExecContext(ctx, stmt, movie.Title, movie.Description, movie.Year, movie.ReleaseDate, movie.Runtime, movie.Rating, movie.MPAARating, movie.UpdateAt, movie.ID)
